...
const MenuPrincipal = () => {
  ...
  const abrirTicket = () => {
    ...
    router.push({
      pathname: "/Ticket",
      params: { comanda: JSON.stringify(comandaActiva), id_mesa: idMesa },
    });
  };
  const abrirPago = () => {
    if (!comandaActiva) return;
        ...
        <View style={s.containerButtons}>
          ...
          >
            <Ionicons
              ...
              size={normalize(22)}
              color={
                comandaActiva?.comanda?.ID_CLIENTE ? gb.green500 : gb.blue550
              }
            />
            <Text
              style={[
                s.botonAccionTexto,
                comandaActiva?.comanda?.ID_CLIENTE && { color: gb.green500 },
              ]}
            >
              {clienteSeleccionado
          ...
          >
            <Ionicons
              ...
              color={gb.purple550}
            />
            <Text style={[s.botonAccionTexto, { color: gb.purple550 }]}>
              Ticket
            </Text>
          </Button>
          <View style={s.botonAccionDivider} />
          <Button
            styleContainer={s.botonAccionContainer}
            style={[s.botonAccion, s.botonPagar]}
            onPress={abrirPago}
          >
            <Ionicons
              name="cash-outline"
              ...
              color={gb.gray50}
            />
            <Text style={[s.botonAccionTexto, { color: gb.gray50 }]}>
              Pagar
            </Text>
          </Button>
        </View>
      ...
      >
        ...
        <FlatList
          ...
          ListHeaderComponent={
            ...
            >
              <View
                style={[s.modalClienteAvatar, { backgroundColor: gb.gray200 }]}
              >
                <Ionicons
                  name="person-outline"
                  size={normalize(18)}
