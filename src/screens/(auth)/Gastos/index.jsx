    ...
    return (
        <SafeAreaView edges={["bottom"]} style={{ flex: 1, backgroundColor: "black" }}>
            ...
            >
                ...
                <Button style={s.btnSync} onPress={sincronizarGastos} disabled={sincronizando}>
                    <Ionicons name="sync-outline" size={normalize(20)} color="white" />
                    <Text style={s.btnSyncText}>{sincronizando ? "..." : "Sincronizar Gastos"}</Text>
                </Button>
            </LinearGradient>
